...
public class OrigemAcademico extends OrigemAbstrata {
    ...
    public OrigemAcademico(int intelecto) {
        this.nome = "Acadêmico";
        this.periciaTreinada1 = new Pericia("Ciência", "Treinado", 5, intelecto, true, false, false);;
        this.periciaTreinada2 = new Pericia("Investigação", "Treinado", 5, intelecto, false, false, false);
